...
class CBOWModel:
    ...
    def _create_embedding(self):
        ...
        with tf.name_scope('embed'):
            ...
            self.sum_embed = tf.reduce_sum(self.embed, 1)
    ...
    def visualize(self, visual_fld, num_visualize):
        ...
        cbow_utils.most_common_words(visual_fld, num_visualize)
...
def gen():
    yield from cbow_utils.batch_gen(DOWNLOAD_URL, EXPECTED_BYTES, VOCAB_SIZE,
...
def main():
    ...
    model = CBOWModel(dataset, VOCAB_SIZE, EMBED_SIZE, BATCH_SIZE, NUM_SAMPLED, LEARNING_RATE)
    model.build_graph()
